  ...
  return (
    <div className="w-full">
      <div className="bg-[#FFFFFF] rounded-t-[24px] lg:pt-0 xs:pt-[220px] pt-[150px] pb-[120px] h-full xl:gap-0 gap-[40px] w-full items-center flex lg:flex-row flex-col justify-between lg:px-[100px] sm:px-[40px] px-[20px]">
        <div className="flex flex-col lg:items-start items-center lg:w-[467px] sm:w-[70%]">
          ...
          <PrimaryLink
            href="/contact"
            title="Book Now"
            style="py-4 px-8 rounded-[34px] text-white bg-[#100E10] font-Pangram-Medium text-xs mt-6 hover:text-[#100E10] hover:bg-transparent border border-transparent hover:border-[#100E10]"
          />
        </div>
        <Image src={service_hero_image} alt="Service hero image" className="relative xl:left-[140px] lg:left-0" />
      </div>
    </div>
  );
};
