  ...
  ">
    {people.map((person) => (
      ...
      <div className="md:col-span-6 w-full md:mt-0 mt-5">
        <LifeDescription name={selectedPerson.name} description={selectedPerson.description} designation={selectedPerson.designation} gdc={selectedPerson.gdc}/>
      </div>
