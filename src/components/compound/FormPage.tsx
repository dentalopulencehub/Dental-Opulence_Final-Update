...
const Page = () => {
  ...
  return (
    ...
    <>
      <section className="relative bg-black w-[99%] min-h-[98vh] top-2 h-full overflow-hidden  rounded-3xl  sm:pt-10 xl:px-40 flex flex-col items-center justify-between  mx-auto my-auto">
        {/* selected options */}{" "}
