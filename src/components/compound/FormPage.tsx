    ...
    <>
      ...
      <section className="relative bg-[#100E10] w-full min-h-[100vh] h-full overflow-hidden  rounded-3xl  sm:pt-10 xl:px-[120px] flex flex-col items-center justify-between  mx-auto my-auto">
        ...
        <div className="w-full h-[100vh] absolute flex items-center justify-center">
          <svg width="1053" height="545" viewBox="0 0 1053 545" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g opacity="0.02">
              <path d="M0 1.35739H202.961C238.646 1.31262 273.991 8.29277 306.973 21.8987C339.955 35.5046 369.928 55.4693 395.178 80.6512C420.427 105.833 440.458 135.738 454.125 168.656C467.791 201.574 474.826 236.86 474.826 272.495C474.826 344.405 446.219 413.37 395.298 464.218C344.378 515.066 275.314 543.632 203.302 543.632H0V1.35739Z" fill="white" />
              <path d="M780.112 545C930.824 545 1053 422.998 1053 272.5C1053 122.002 930.824 0 780.112 0C629.4 0 507.223 122.002 507.223 272.5C507.223 422.998 629.4 545 780.112 545Z" fill="white" />
            </g>
          </svg>
        </div>
        {/* selected options */}{" "}
        ...
        <div className="flex w-full  items-center mt-12 relative justify-between">
          {visitedSteps.length == 0 ? <nav className=" mix-blend-difference h-[70px] bg-transparent cursor-pointer  flex items-center justify-between  ">
            <div className="" onClick={() => handleSetPathToNavigate(dispatch, "/")}>
        ...
        <div className="relative justify-between items-center flex  w-full mb-12">
          ...
          {visitedSteps.length != 0 ? <nav className="left-0  mix-blend-difference h-[70px] bg-transparent cursor-pointer flex items-center justify-between  ">
          ...
          </nav> : <div className="h-[70px]" />}
          <div className="w-[70%] h-2 bg-[#5C5C5C] rounded-full">
