...
const HomeHero = () => {
  return (
    <div className="bg-white sm:pt-5 sm:px-5 px-2 pt-2">
      <div className="bg-[#100E10] rounded-t-[24px] pt-[220px] pb-[100px] w-full h-full items-center flex xl:flex-row flex-col justify-between lg:px-[100px] sm:px-[40px] px-10">
