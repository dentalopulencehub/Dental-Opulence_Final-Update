  ...
  return (
    <div className="bg-[#100E10] sm:px-5 px-2 w-full">
      <div className="w-full lg:px-[100px] sm:px-[40px] px-[20px] py-[80px] bg-white">
        ...
        <h2 className="mt-4 text-[#100E10] text-[32px] leading-[38px] font-Pangram-Bold w-[333px]">
          Client Favorites for Proven Results.
        </h2>

        <div className="mt-10 flex flex-wrap lg:justify-between justify-center lg:gap-0 gap-[30px]">
