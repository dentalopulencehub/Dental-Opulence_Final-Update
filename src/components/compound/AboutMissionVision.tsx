...
const AboutMissionVision = () => {
  ...
  const Card = ({ index,title, icon, activeIcon }: { index:number,title: string, icon: any, activeIcon: any }) => {
    return <div onClick={()=>setShowOverlay(index)} className='cursor-pointer rounded-lg group hover:bg-white w-full  bg-[#2D2D2D] font-medium text-[#D0D0D0] hover:text-[#161616] flex flex-col gap-8 items-center aspect-[4/3] justify-center'>
