...
const AboutMissionVision = () => {
  ...
  const Card = ({
    ...
    return (
      <div
        ...
        className="cursor-pointer rounded-lg group hover:bg-white w-full  bg-[#2D2D2D] font-medium text-[#D0D0D0] hover:text-[#161616] flex flex-col gap-8 items-center aspect-[4/3] justify-center"
      >
  ...
  const Overlay = ({ children }: { children: ReactNode }) => {
    return (
      <div
        ...
        className="fixed top-0 z-50 bg-transparent backdrop-blur-sm w-[100vw] h-[100vh] flex items-center justify-center"
      >
        <div
          onClick={(e) => e.stopPropagation()}
          className="bg-[#222222] w-[70%] md:w-[30%] aspect-[2/1] flex flex-col items-center text-[#F2F2F2] p-8 justify-center rounded-xl text-l"
        >
          <div className="flex w-full justify-end mb-4">
            <button onClick={() => setShowOverlay(false)}>
              ...
              >
                <path
                  d="M9.16655 0.833286L0.833252 9.16659M0.833217 0.833252L9.16652 9.16655"
                  stroke="white"
                  stroke-width="1.5"
  ...
  return (
    <div className="w-auto  bg-[#100E10]">
      {showOverlay && (
        <Overlay>
          {showOverlay == 1 && (
            <p>
              Enter post code B28 8AB in your navigation or map application. You
              will arrive outside the practice where you can park for free
              (subject to availability).
            </p>
          )}
          {showOverlay == 2 && (
            <p>
              We are a 3 minute walk from Hall Green Train Station. You can
              travel in from Snow Hill & Moor Street Stations via a 10 minute
              train ride.
            </p>
          )}
          {showOverlay == 3 && (
            <p>
              We are situated on Stratford Road and have plenty of free parking
              for patients on site. This is subject to availability.
            </p>
          )}
          {showOverlay == 4 && (
            <p>
              To streamline our appointment scheduling, please be aware of our
              48-hour cancellation policy and the necessity of deposits when
              booking appointments. We understand the financial considerations
              of dental care and are pleased to offer 0% financing options for
              your convenience. Thank you for choosing our dental practice,
              where your oral health and convenience are our top priorities.
            </p>
          )}
        </Overlay>
      )}
        ...
        <div className="flex xl:flex-row flex-col gap-6 w-full">
          <div className="flex flex-col flex-wrap gap-6 justify-between xl:max-w-[425px] w-full">
            <div className="sm:max-w-[425px] w-full xl:h-[225px] bg-[#222222] rounded-2xl xs:p-10 p-7">
              ...
              <h3 className="text-white text-[30px] md:text-[48px] mt-[38px]">
                Who we are
              </h3>
            </div>
          ...
          <div className="flex flex-col gap-6 w-full">
            ...
            <div className="w-full bg-[#222222] rounded-2xl flex flex-col md:flex-row md:justify-around justify-between xs:p-10 p-7 sm:gap-0 gap-10 ">
              <div className="flex flex-row justify-between md:w-[45%]">
              ...
              <div className="flex justify-center md:w-[10%]">
                <div className="flex flex-col items-center justify-center gap-2">
                  ...
                  <h3 className="text-[48px] text-white">1000+</h3>
                  <p className="text-base font-Pangram-Regular text-center text-[#D0D0D0]">
